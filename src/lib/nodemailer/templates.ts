                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <h1 style="margin: 0 0 24px 0; font-size: 32px; font-weight: 600; color: #ffffff; line-height: 1.2;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #9ca3af;">
                                Thank you for signing up with Signalist! To complete your registration and start tracking your favorite stocks, please verify your email address by clicking the button below.
                            </p>

                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding: 12px 0;">
                                        <a href="{{verificationUrl}}" style="display: inline-block; padding: 16px 32px; background-color: #FACC15; color: #000000; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 14px; line-height: 1.6; color: #FACC15; word-break: break-all;">
                                {{verificationUrl}}
                            </p>

                            <div style="margin: 32px 0; padding: 16px; background-color: #1f2937; border-radius: 6px; border-left: 4px solid #FACC15;">
                                <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #9ca3af;">
                                    <strong style="color: #ffffff;">⚠️ Important:</strong> This verification link will expire in 24 hours.
                                </p>
                            </div>

                            <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #6b7280;">
                                If you didn't create an account with Signalist, you can safely ignore this email.
                            </p>
                    ...
                    <tr>
                        <td style="padding: 20px 40px 40px 40px; border-top: 1px solid #30333A;">
                            <div style="text-align: center; margin: 20px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #6b7280;">
                                    Questions? Reply to this email or contact our support team.
                                </p>
